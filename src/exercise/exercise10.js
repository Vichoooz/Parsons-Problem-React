...
const initialCode = `operacion = input("Elige una operación (+, -, *, /): ")<br>numero1 = float(input("Ingresa el primer número: "))<br>numero2 = float(input("Ingresa el segundo número: "))
if operacion == "+":
    ...
    if numero2 == 0:
        ...
        print("Resultado:", numero1 / numero2)
else:<br>&nbsp;&nbsp;&nbsp;&nbsp;print("Operación no válida.")`;
