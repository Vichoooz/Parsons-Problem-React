...
const initialCode = `dinero = float(input("¿Cuánto dinero tienes? "))<br>precio_producto = float(input("¿Cuánto cuesta el producto? "))<br>if dinero > precio_producto:
...
print("No tienes suficiente dinero. Te falta: "+sobra) #distractor`;
