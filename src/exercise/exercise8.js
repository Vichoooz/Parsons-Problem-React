...
const initialCode = `nota1 = int(input("Ingresa la nota del primer examen: "))<br>nota2 = int(input("Ingresa la nota del segundo examen: "))<br>nota3 = int(input("Ingresa la nota del tercer examen: "))
